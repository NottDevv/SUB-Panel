...
این پروژه برای اجرا روی هاست‌های رایگان مثل **InfinityFree** یا **Serv00** کاملاً بهینه شده است.
...
2.  در کادر "نام لینک" (مثلاً: همراه اول) و کادر "لینک" (مثلاً: `vless://...`) را پر کنید.
